...
> **Namespaced skills (v1.0.88+)**: Skill discovery now supports namespaced custom skills and ignored skill directories, letting you organize larger skill collections — for example, grouping skills under a team or product namespace — and exclude specific folders from discovery without moving them out of your skills directory.
